...
export default function ImpressumPage() {
  return <main id="main" className="narrow section legal-copy">
    ...
    <p><strong>Verantwortlich für die Website i.S.d. TMG und Verantwortlicher nach § 55 II RStV:</strong><br />René Aufhauser<br />Tauxgasse 24A<br />5020 Salzburg<br />Österreich</p>
    ...
    <h2>Datenschutz</h2><p>Informationen zur Verarbeitung personenbezogener Daten, zum Kontaktformular und zur E-Mail-Zustellung über Resend finden Sie in unserer <Link href="/datenschutz">Datenschutzerklärung</Link>.</p>
  </main>;
}
