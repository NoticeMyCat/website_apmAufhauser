...
export default function AboutPage() {
  return <main id="main">
    <header className="wrap page-hero"><h1>Über mich</h1></header>
    <section className="wrap section-tight bio-grid">
      ...
      <div className="bio-copy">
        <h2>Meine Wurzeln und Familie</h2>
